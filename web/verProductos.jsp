...
<html>
    ...
    <body>
        ...
        <jsp:include page="productos.jsp">
            ...
            <jsp:param name="descripcion_producto1" value="GIGABYTE Laptop Gamer Aero X16 NVIDIA GeForce RTX 5060 AMD Ryzen AI 7 350 32GB RAM 1TB SSD 16" />
            ...
            <jsp:param name="descripcion_producto2" value="Raspberry Pi 5 Microcomputadora con procesador ARM Cortex, 8GB RAM, 64GB almacenamiento, conectividad Wi-Fi y Bluetooth" />
            ...
            <jsp:param name="descripcion_producto3" value="Logitech G203 LIGHTSYNC Mouse Gaming con Iluminación RGB Personalizable, 6 Botones Programables Seguimiento de hasta 8,000 DPI, Ultra" />
            ...
            <jsp:param name="descripcion_producto4" value="Free wolf M96 Teclado Inalambrico Español, Bluetooth y 2.4GHz 2 Modes Teclado Gaming, con Pantalla LED y Luz de Retroiluminación Rainbow, para Oficina y Juegos|" />
            ...
            <jsp:param name="descripcion_producto5" value="15.6 Pulgadas 1080P Extended Monitor, 1000:1 100% sRGB USB-C HDMI Display portátil para portátil Pantalla de Viaje HDR para PC PS5/4 Xbox Switch" />
